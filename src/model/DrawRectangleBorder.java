...
public class DrawRectangleBorder extends BorderShape {
    private PaintCanvasBase paintCanvas;
    private ShapeDetails shapeDetails;

    public DrawRectangleBorder(IShapeDrawer borderShape, PaintCanvasBase paintCanvas, ShapeDetails shapeDetails) {
    ...
    public void draw(){
        ...
        graphics2d.drawRect(shapeDetails.getX()-5, shapeDetails.getY()-5, shapeDetails.getWidth()+10, shapeDetails.getHeight()+10);
        graphics2d.dispose();
    }
